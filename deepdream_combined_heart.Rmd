...
```{r warning=FALSE, message=FALSE}
# Define file paths
file_paths <- list.files(path = "pre-study", pattern = "_DeviceData.csv", full.names = TRUE)
...
# Define file paths
file_paths <- list.files(path = "pre-study", pattern = "_Baseline.csv", full.names = TRUE)
