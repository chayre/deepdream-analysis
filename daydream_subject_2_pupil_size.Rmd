  ...
  ggplot(data, aes(x = ExperimentSecond - ExperimentSecond[1])) +
    ...
    scale_color_manual(
      values = c(
        ...
        "Luminosity" = adjustcolor("green", alpha.f = 0.5)
      ),
      breaks = c("Left Pupil Size", "Right Pupil Size", "Luminosity") # Correct legend order
    )
}

# Define common y-axis limits
common_y_limits <- c(0, 6)  # Adjust based on your data
...
p <- (plot1 + plot2) / (plot3 + plot4) +
  ...
  plot_annotation(title = "Subject 2 Pupil Size During DayDream Video") # Add a supertitle
