...
find_stable_gaze_regions <- function(data, threshold, duration, cooldown) {
  ...
  in_region <- FALSE
  start_time <- NA
  last_end_time <- -Inf  # Ensure cooldown logic works
...
x_tolerance <- 0.3           # Gaze difference tolerance (adjust as needed)
duration_threshold <- 3     # Minimum number of points for stability (adjust as needed)
cooldown = 2               # Minimum number of points before another rectangle can be drawn (adjust as needed)
...
#  plot_annotation(title = "Subject 2 Pupil Size with Gaze Directions During DayDream Video; Stable Gaze #Regions  Highlighted")
