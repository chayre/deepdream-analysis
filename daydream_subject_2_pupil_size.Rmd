...
model_gam <- gam((LeftEyePupilSize + RightEyePupilSize) / 2 ~ s(InverseLuminosity), data = filtered_data)
...
plot1 <- create_pupil_plot(
  data_linear %>% 
    filter(data_linear$VideoMode == "Normal", data_linear$VideoName == "Main_Mono_HighLayer_Strong", data_linear$Phase == "Video"), "Normal Mono Linear Residual", common_y_limits, luminosity_factor)
plot2 <- create_pupil_plot(
  data_linear %>% 
    filter(data_linear$VideoMode == "Normal", data_linear$VideoName == "Main_Stereo_HighLayerStrong", data_linear$Phase == "Video"), "Normal Stereo Linear Residual", common_y_limits, luminosity_factor)
plot3 <- create_pupil_plot(
  data_linear %>% 
    filter(data_linear$VideoMode == "Hallucinations", data_linear$VideoName == "Main_Mono_HighLayer_Strong", data_linear$Phase == "Video"), "Hallucination Mono Linear Residual", common_y_limits, luminosity_factor)
plot4 <- create_pupil_plot(
  data_linear %>% 
    filter(data_linear$VideoMode == "Hallucinations", data_linear$VideoName == "Main_Stereo_HighLayerStrong", data_linear$Phase == "Video"), "Hallucination Stereo Linear Residual", common_y_limits, luminosity_factor)
...
plot1 <- create_pupil_plot(
  data_gam %>% 
    filter(data_gam$VideoMode == "Normal", data_gam$VideoName == "Main_Mono_HighLayer_Strong", data_gam$Phase == "Video"), "Normal Mono GAM Residual", common_y_limits, luminosity_factor)
plot2 <- create_pupil_plot(
  data_gam %>% 
    filter(data_gam$VideoMode == "Normal", data_gam$VideoName == "Main_Stereo_HighLayerStrong", data_gam$Phase == "Video"), "Normal Stereo GAM Residual", common_y_limits, luminosity_factor)
plot3 <- create_pupil_plot(
  data_gam %>% 
    filter(data_gam$VideoMode == "Hallucinations", data_gam$VideoName == "Main_Mono_HighLayer_Strong", data_gam$Phase == "Video"), "Hallucination Mono GAM Residual", common_y_limits, luminosity_factor)
plot4 <- create_pupil_plot(
  data_gam %>% 
    filter(data_gam$VideoMode == "Hallucinations", data_gam$VideoName == "Main_Stereo_HighLayerStrong", data_gam$Phase == "Video"), "Hallucination Stereo GAM Residual", common_y_limits, luminosity_factor)
